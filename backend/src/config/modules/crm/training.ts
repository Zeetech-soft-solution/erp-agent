...
export const CRM_TRAINING: ModuleTrainingConfig = {
  module: "crm",
  pseudonymizeFields: ["email", "phone", "display_name"],
  retentionDays: 180,
  notes: "Lead/contact details are direct PII — strip or hash before any fine-tuning export, per TRAINING_PLAN.md's governance notes.",
};
